...
final class SettingsStore {
    var accentTint: DesignTint { didSet { defaults.set(accentTint.rawValue, forKey: Keys.tint) } }
    ...
    var buttonTint: DesignTint { didSet { defaults.set(buttonTint.rawValue, forKey: Keys.buttonTint) } }
    ...
    init(defaults: UserDefaults = .standard) {
        ...
        accentTint = DesignTint(rawValue: defaults.string(forKey: Keys.tint) ?? "") ?? .multicolor
        ...
        buttonTint = DesignTint(rawValue: defaults.string(forKey: Keys.buttonTint) ?? "") ?? .multicolor
