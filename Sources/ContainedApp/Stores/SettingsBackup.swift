...
struct SettingsBackup: Codable, Equatable {
    ...
    init(accentTint: DesignTint,
         ...
         buttonTint: DesignTint = .multicolor,
    ...
    init(from decoder: Decoder) throws {
        ...
        accentTint = try container.decode(DesignTint.self, forKey: .accentTint)
        ...
        buttonTint = try container.decodeIfPresent(DesignTint.self, forKey: .buttonTint) ?? .multicolor
