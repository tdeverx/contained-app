...
struct Personalization: Codable, Hashable, Sendable {
    ...
    var backgroundBlendMode: UI.Theme.ColorBlendMode = .softLight
    ...
    var graphStyle: UI.Chart.GraphStyle {
    ...
    init(from decoder: Decoder) throws {
        ...
        backgroundBlendMode = try container.decodeIfPresent(UI.Theme.ColorBlendMode.self, forKey: .backgroundBlendMode)
            ?? .softLight
