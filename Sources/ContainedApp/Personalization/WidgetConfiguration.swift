...
struct WidgetConfiguration: Codable, Hashable, Sendable {
    ...
    var interpolation: UI.Chart.Interpolation = .linear
    ...
    init(from decoder: Decoder) throws {
        ...
        let decodedInterpolation = try container.decodeIfPresent(UI.Chart.Interpolation.self, forKey: .interpolation)
