...
enum AppText {
    ...
    static func cleanedOrphanedRows(_ count: Int) -> String {
        string("cleanup.cleanedOrphanedRows", defaultValue: "Cleaned \(count) orphaned row(s)")
    }
    ...
    static func setThemeTintTitle(_ tintName: String) -> String {
        string("palette.setThemeTint", defaultValue: "Set app tint to \(tintName)")
    }
}
...
extension UI.Theme.ColorBlendMode {
    var localizedDisplayName: String {
        switch self {
...
extension UI.Theme.WindowMaterial {
    var localizedDisplayName: String {
        switch self {
...
extension UI.Chart.Interpolation {
    var localizedDisplayName: String {
        switch self {
