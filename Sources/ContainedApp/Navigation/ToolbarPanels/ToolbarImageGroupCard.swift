...
struct ToolbarImageGroupCard: View {
        ...
        ScrollView {
            LazyVStack(alignment: .leading, spacing: DesignTokens.Space.s) {
                VStack(alignment: .leading, spacing: DesignTokens.DesignCard.compactTextSpacing) {
                    ...
                    if let subtitle {
                        DesignCardMonospacedSubtitleText(text: subtitle)
                    }
                }
    ...
    private var imagePageControlItems: [DesignCardPageControlItem<ImageDetailPage>] {
    ...
    private var imagePages: DesignCardPages<ImageDetailPage> {
        DesignCardPages(items: imagePageControlItems,
                          selection: page,
    ...
    private func imageFooterInfo(_ status: ImageUpdateStatus) -> some View {
        DesignCardFooterMini {
            ...
            DesignCardSubtitleText(text: updateFooterText(status))
        }
    }
    ...
    private func imageFooterTagCount(_ group: LocalImageTagGroup) -> some View {
        DesignCardFooterMini {
            ...
            DesignCardMetricText(text: "\(group.references.count)")
        }
    }
    ...
    private func tagRow(_ reference: String, in group: LocalImageTagGroup) -> some View {
        ...
        return DesignCard(size: .medium,
            ...
            DesignCardFooterMini {
                ...
                DesignCardMetricText(text: "Local tag")
            }
        } footerActions: {
            footerAction("play", help: AppText.run) {
