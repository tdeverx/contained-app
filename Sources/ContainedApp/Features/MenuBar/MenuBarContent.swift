...
struct MenuBarContent: View {
    ...
    var body: some View {
        ...
        .padding(DesignTokens.MenuBar.padding)
        .frame(width: DesignTokens.MenuBar.width)
    }

    @ViewBuilder
    private var header: some View {
        VStack(alignment: .leading, spacing: DesignTokens.Toolbar.searchIconGap) {
            ...
            HStack(spacing: DesignTokens.DesignCard.padding) {
    ...
    private func infoRow(_ title: String, value: String) -> some View {
        HStack(alignment: .firstTextBaseline, spacing: DesignTokens.DesignCard.padding) {
            Text(title)
                .foregroundStyle(.secondary)
                .frame(width: DesignTokens.MenuBar.titleWidth, alignment: .leading)
            Text(value)
