...
struct SettingsBackup: Codable, Equatable {
    var accentTint: UI.Theme.Tint
    var appearance: UI.Theme.Appearance
    var density: UI.Card.Density
    var windowMaterial: UI.Theme.WindowMaterial
    var modalMaterial: UI.Theme.WindowMaterial
    var buttonMaterial: UI.Theme.WindowMaterial
    var buttonTintEnabled: Bool
    var buttonTint: UI.Theme.Tint
    var buttonTintOpacity: Double
    var buttonTintGradient: Bool
    var buttonTintGradientAngle: Double
    var buttonTintBlendMode: UI.Theme.ColorBlendMode
    var cardMaterial: UI.Theme.WindowMaterial
    ...
    init(accentTint: UI.Theme.Tint,
         appearance: UI.Theme.Appearance,
         density: UI.Card.Density,
         windowMaterial: UI.Theme.WindowMaterial,
         modalMaterial: UI.Theme.WindowMaterial,
         buttonMaterial: UI.Theme.WindowMaterial,
         buttonTintEnabled: Bool = false,
         buttonTint: UI.Theme.Tint = .multicolor,
         ...
         buttonTintBlendMode: UI.Theme.ColorBlendMode = .softLight,
         cardMaterial: UI.Theme.WindowMaterial,
         showInfoTips: Bool,
    ...
    init(from decoder: Decoder) throws {
        ...
        accentTint = try container.decode(UI.Theme.Tint.self, forKey: .accentTint)
        appearance = try container.decode(UI.Theme.Appearance.self, forKey: .appearance)
        density = try container.decode(UI.Card.Density.self, forKey: .density)
        windowMaterial = try container.decode(UI.Theme.WindowMaterial.self, forKey: .windowMaterial)
        modalMaterial = try container.decode(UI.Theme.WindowMaterial.self, forKey: .modalMaterial)
        buttonMaterial = try container.decodeIfPresent(UI.Theme.WindowMaterial.self, forKey: .buttonMaterial) ?? .glassClear
        buttonTintEnabled = try container.decodeIfPresent(Bool.self, forKey: .buttonTintEnabled) ?? false
        buttonTint = try container.decodeIfPresent(UI.Theme.Tint.self, forKey: .buttonTint) ?? .multicolor
        ...
        buttonTintBlendMode = try container.decodeIfPresent(UI.Theme.ColorBlendMode.self, forKey: .buttonTintBlendMode)
            ?? .softLight
        cardMaterial = try container.decodeIfPresent(UI.Theme.WindowMaterial.self, forKey: .cardMaterial) ?? .glassRegular
