...
struct ExperimentalTab: View {
    ...
    var body: some View {
        LazyVStack(spacing: UI.Layout.Spacing.l) {
            UI.Panel.Section(header: AppText.sectionSettingsExperimental,
                ...
                UI.Panel.ToggleRow(title: AppText.string("settings.experimental.toolbarFirstUI", defaultValue: "Toolbar-first UI"),
                ...
                UI.Panel.ToggleRow(title: AppText.string("settings.experimental.sidebarNavigation", defaultValue: "Sidebar navigation"),
                ...
                UI.Panel.ToggleRow(title: AppText.string("settings.experimental.commandPalette", defaultValue: "Command palette (Command-K)"),
                ...
                UI.Panel.ToggleRow(title: AppText.string("settings.experimental.dockerHubSearch", defaultValue: "Docker Hub search"),
                ...
                UI.Panel.ToggleRow(title: AppText.string("settings.experimental.composeImport", defaultValue: "Compose import"),
                ...
                UI.Panel.ToggleRow(title: AppText.string("settings.experimental.imageBuildWorkspace", defaultValue: "Image build workspace"),
                ...
                UI.Panel.ToggleRow(title: AppText.string("settings.experimental.keyboardShortcuts", defaultValue: "Keyboard shortcuts"),
