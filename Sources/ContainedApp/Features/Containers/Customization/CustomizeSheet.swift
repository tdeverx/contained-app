...
struct CustomizeSheet: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            ScrollView {
                ...
                .padding(.vertical, UI.Layout.Spacing.m)
            }
    ...
    private var header: some View {
        UI.Panel.Header(symbol: "paintbrush.pointed",
                    title: headerTitle,
                    subtitle: imageSubtitle) {
            UI.Action.Group([
                UI.Action.Item(systemName: "checkmark", help: AppText.save) { save() },
                UI.Action.Item(systemName: "xmark", help: AppText.close, isCancel: true) { dismiss() }
            ])
        }
    }

    private var inheritanceSection: some View {
        UI.Panel.Section(header: AppText.string("customize.inheritance", defaultValue: "Inheritance")) {
            UI.Panel.ToggleRow(title: overrideToggleTitle,
    ...
    private var styleSection: some View {
        UI.Panel.Section(header: AppText.string("customize.style", defaultValue: "Style")) {
            ...
            if style.iconEnabled {
                ...
                UI.Panel.Row(title: AppText.string("customize.icon", defaultValue: "Icon"),
    ...
    private var actionsSection: some View {
        UI.Panel.Section {
            UI.Panel.Row(title: target.isImage
            ...
            if case .container = target {
                UI.Panel.Row(title: AppText.string("customize.applyToImage", defaultValue: "Apply to image"),
