...
Container edit opens the same [Run / Edit Form](/docs/features/Run-Edit-Form.md) used for new
containers. Toolbar panel navigation opens it in the [Creation Workflow](/docs/features/Creation-Workflow.md)
