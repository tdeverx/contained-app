...
public extension Core.Schema.Definition {
    ...
    static var appleContainerRunFields: [Core.Schema.FieldDescriptor] {
        ...
        func appleTip(_ key: String, _ text: String) -> [Core.Runtime.Kind: Core.Schema.FieldTipRef] {
            [.appleContainer: Core.Schema.FieldTipRef(key: key, defaultText: text)]
        }

        func apple(_ path: Core.Field.Path,
            ...
            return Core.Schema.FieldDescriptor(
                ...
                tipRefs: appleTip("schema.tip.\(path.rawValue).apple-container", tip),
                sourceAliases: aliases
            )
        }

        func disabled(_ path: Core.Field.Path,
                      _ kind: Core.Schema.ValueKind,
                      _ label: String,
                      defaultValue: Core.Schema.Value,
                      docker: (String, String)? = nil,
            ...
            return Core.Schema.FieldDescriptor(
                ...
                defaultLabel: label,
                defaultValue: defaultValue,
                support: [.appleContainer: unsupported],
                tipRefs: appleTip("schema.tip.\(path.rawValue).apple-container", tip),
                sourceAliases: aliases
            )
        }
        ...
        return [
            ...
            apple(.imagePlatform, .string, .essentials, "Platform", defaultValue: .string(""),
                  flag: "--platform", example: "--platform linux/arm64", docker: ("--platform", "--platform linux/arm64"), compose: ("platform", "platform: linux/arm64"),
                  tip: "Pins a multi-platform image to an OS and architecture. Apple container lets this override OS and architecture."),
            apple(.imageOS, .string, .essentials, "Image OS", defaultValue: .string(""),
            ...
            apple(.imageArchitecture, .string, .essentials, "Image architecture", defaultValue: .string(""),
            ...
            apple(.containerName, .string, .essentials, "Name", defaultValue: .string(""),
            ...
            apple(.processCommand, .commandLine, .essentials, "Command", defaultValue: .commandLine([]),
            ...
            apple(.processEntrypoint, .string, .process, "Entrypoint", defaultValue: .string(""),
            ...
            apple(.processDetach, .bool, .essentials, "Run in the background", defaultValue: .bool(true),
            ...
            apple(.processRemoveOnExit, .bool, .essentials, "Remove when stopped", defaultValue: .bool(false),
            ...
            apple(.resourcesCPULimit, .string, .resources, "CPUs", defaultValue: .string(""),
            ...
            apple(.resourcesMemoryLimit, .string, .resources, "Memory", defaultValue: .string(""),
            ...
            apple(.networkPorts, .portList, .networking, "Ports", defaultValue: .portList([]),
            ...
            apple(.networkName, .string, .networking, "Network", defaultValue: .string(""),
            ...
            apple(.networkSockets, .socketList, .networking, "Sockets", defaultValue: .socketList([]),
                  flag: "--publish-socket", example: "--publish-socket /tmp/app.sock:/run/app.sock",
                  tip: "Publishes a host socket path into the container."),
            apple(.storageVolumes, .volumeList, .storage, "Volumes", defaultValue: .volumeList([]),
            ...
            apple(.storageMounts, .stringList, .storage, "Mounts", defaultValue: .stringList([]),
            ...
            apple(.storageTmpfs, .stringList, .storage, "Tmpfs mounts", defaultValue: .stringList([]),
            ...
            apple(.environmentVariables, .keyValueList, .environment, "Environment variables", defaultValue: .keyValueList([]),
            ...
            apple(.environmentFiles, .stringList, .environment, "Environment files", defaultValue: .stringList([]),
            ...
            apple(.lifecycleRestartPolicy, .enumeration, .metadata, "Restart policy", defaultValue: .enumeration("no"), options: restartOptions,
            ...
            apple(.metadataLabels, .keyValueList, .metadata, "Labels", defaultValue: .keyValueList([]),
            ...
            apple(.processInteractive, .bool, .process, "Keep stdin open", defaultValue: .bool(false),
            ...
            apple(.processTTY, .bool, .process, "Allocate TTY", defaultValue: .bool(false),
                  flag: "--tty", example: "--tty", docker: ("--tty", "--tty"), compose: ("tty", "tty: true"),
                  tip: "Allocates a terminal for the process."),
            apple(.processWorkingDirectory, .string, .process, "Working directory", defaultValue: .string(""),
            ...
            apple(.processUser, .string, .process, "User", defaultValue: .string(""),
            ...
            apple(.processUserID, .string, .process, "User ID", defaultValue: .string(""),
                  flag: "--uid", example: "--uid 1000", tip: "Sets the numeric user ID for the process."),
            apple(.processGroupID, .string, .process, "Group ID", defaultValue: .string(""),
                  flag: "--gid", example: "--gid 1000", tip: "Sets the numeric group ID for the process."),
            apple(.resourcesSharedMemorySize, .string, .process, "Shared memory", defaultValue: .string(""),
            ...
            apple(.processUlimits, .stringList, .process, "Resource limits", defaultValue: .stringList([]),
            ...
            apple(.securityCapabilitiesAdd, .stringList, .security, "Add capabilities", defaultValue: .stringList([]),
            ...
            apple(.securityCapabilitiesDrop, .stringList, .security, "Drop capabilities", defaultValue: .stringList([]),
            ...
            apple(.outputContainerIDFile, .string, .process, "Container ID file", defaultValue: .string(""),
            ...
            apple(.securityReadOnlyRootFS, .bool, .security, "Read-only filesystem", defaultValue: .bool(false),
            ...
            apple(.securityUseInit, .bool, .security, "Use an init process", defaultValue: .bool(false),
            ...
            apple(.securityRosetta, .bool, .security, "Rosetta", defaultValue: .bool(false),
                  flag: "--rosetta", example: "--rosetta", tip: "Allows x86-64 Linux binaries to run through Rosetta when supported."),
            apple(.securitySSHAgent, .bool, .security, "Forward SSH agent", defaultValue: .bool(false),
                  flag: "--ssh", example: "--ssh", tip: "Forwards your host SSH agent socket into the container."),
            apple(.securityVirtualization, .bool, .security, "Expose virtualization", defaultValue: .bool(false),
            ...
            apple(.networkDNSDisabled, .bool, .networking, "Disable DNS", defaultValue: .bool(false),
                  flag: "--no-dns", example: "--no-dns", tip: "Prevents DNS from being configured in the container."),
            apple(.networkDNSServers, .stringList, .networking, "DNS servers", defaultValue: .stringList([]),
                  flag: "--dns", example: "--dns 1.1.1.1", docker: ("--dns", "--dns 1.1.1.1"), compose: ("dns", "dns: [1.1.1.1]"),
                  tip: "Sets DNS nameserver IP addresses."),
            apple(.networkDNSDomain, .string, .networking, "DNS domain", defaultValue: .string(""),
                  flag: "--dns-domain", example: "--dns-domain example.test", tip: "Sets the default DNS domain."),
            apple(.networkDNSSearchDomains, .stringList, .networking, "DNS search domains", defaultValue: .stringList([]),
            ...
            apple(.networkDNSOptions, .stringList, .networking, "DNS options", defaultValue: .stringList([]),
            ...
            apple(.imageInitReference, .string, .imageFetch, "Init image", defaultValue: .string(""),
                  flag: "--init-image", example: "--init-image init:latest", tip: "Uses a custom init image instead of the runtime default."),
            apple(.kernelPath, .string, .imageFetch, "Kernel", defaultValue: .string(""),
                  flag: "--kernel", example: "--kernel /path/to/vmlinux", tip: "Uses a custom kernel path."),
            apple(.runtimeHandler, .string, .imageFetch, "Runtime handler", defaultValue: .string(""),
                  flag: "--runtime", example: "--runtime container-runtime-linux", compose: ("runtime", "runtime: runc"),
                  tip: "Sets the low-level runtime handler."),
            apple(.registryScheme, .enumeration, .imageFetch, "Registry scheme", defaultValue: .enumeration(""), options: schemeOptions,
                  flag: "--scheme", example: "--scheme https", tip: "Controls the registry connection scheme for image fetches."),
            apple(.progressMode, .enumeration, .imageFetch, "Progress", defaultValue: .enumeration(""), options: progressOptions,
            ...
            disabled(.securityPrivileged, .bool, "Privileged", defaultValue: .bool(false), docker: ("--privileged", "--privileged"), compose: ("privileged", "privileged: true"), tip: "Runs with extended host privileges."),
            disabled(.securityOptions, .stringList, "Security options", defaultValue: .stringList([]), docker: ("--security-opt", "--security-opt no-new-privileges=true"), compose: ("security_opt", "security_opt: [no-new-privileges:true]"), tip: "Applies Docker security profiles or labels."),
            disabled(.kernelSysctls, .keyValueList, "Sysctls", defaultValue: .keyValueList([]), docker: ("--sysctl", "--sysctl net.ipv4.ip_forward=1"), compose: ("sysctls", "sysctls: { net.ipv4.ip_forward: 1 }"), tip: "Sets kernel sysctls for the container."),
            disabled(.namespaceCgroup, .string, "Cgroup namespace", defaultValue: .string(""), docker: ("--cgroupns", "--cgroupns private"), compose: ("cgroup", "cgroup: private"), tip: "Controls the cgroup namespace."),
            disabled(.namespaceUser, .string, "User namespace", defaultValue: .string(""), docker: ("--userns", "--userns host"), compose: ("userns_mode", "userns_mode: host"), tip: "Controls the user namespace."),
            disabled(.namespacePID, .string, "PID namespace", defaultValue: .string(""), docker: ("--pid", "--pid host"), compose: ("pid", "pid: host"), tip: "Controls the process namespace."),
            disabled(.namespaceIPC, .string, "IPC namespace", defaultValue: .string(""), docker: ("--ipc", "--ipc host"), compose: ("ipc", "ipc: host"), tip: "Controls the IPC namespace."),
            disabled(.namespaceUTS, .string, "UTS namespace", defaultValue: .string(""), compose: ("uts", "uts: host"), tip: "Controls the UTS namespace."),
            disabled(.resourcesCPUShares, .string, "CPU shares", defaultValue: .string(""), docker: ("--cpu-shares", "--cpu-shares 512"), compose: ("cpu_shares", "cpu_shares: 512"), tip: "Sets relative CPU weight."),
            disabled(.resourcesCPUQuota, .string, "CPU quota", defaultValue: .string(""), docker: ("--cpu-quota", "--cpu-quota 50000"), compose: ("cpu_quota", "cpu_quota: 50000"), tip: "Sets CPU CFS quota."),
            disabled(.resourcesCPUPeriod, .string, "CPU period", defaultValue: .string(""), docker: ("--cpu-period", "--cpu-period 100000"), compose: ("cpu_period", "cpu_period: 100000"), tip: "Sets CPU CFS period."),
            disabled(.resourcesCPUSet, .string, "CPU set", defaultValue: .string(""), docker: ("--cpuset-cpus", "--cpuset-cpus 0-3"), compose: ("cpuset", "cpuset: 0-3"), tip: "Pins execution to specific CPUs."),
            disabled(.resourcesCPURealtimeRuntime, .string, "CPU realtime runtime", defaultValue: .string(""), docker: ("--cpu-rt-runtime", "--cpu-rt-runtime 95000"), compose: ("cpu_rt_runtime", "cpu_rt_runtime: 95000"), tip: "Sets real-time CPU runtime."),
            disabled(.resourcesCPURealtimePeriod, .string, "CPU realtime period", defaultValue: .string(""), docker: ("--cpu-rt-period", "--cpu-rt-period 100000"), compose: ("cpu_rt_period", "cpu_rt_period: 100000"), tip: "Sets real-time CPU period."),
            disabled(.resourcesMemoryReservation, .string, "Memory reservation", defaultValue: .string(""), compose: ("mem_reservation", "mem_reservation: 256M"), tip: "Sets a soft memory reservation."),
            disabled(.resourcesMemorySwapLimit, .string, "Swap limit", defaultValue: .string(""), docker: ("--memory-swap", "--memory-swap 1G"), compose: ("memswap_limit", "memswap_limit: 1G"), tip: "Sets memory plus swap limit."),
            disabled(.resourcesMemorySwappiness, .string, "Memory swappiness", defaultValue: .string(""), docker: ("--memory-swappiness", "--memory-swappiness 0"), compose: ("mem_swappiness", "mem_swappiness: 0"), tip: "Controls anonymous page swapping."),
            disabled(.resourcesOOMKillDisable, .bool, "Disable OOM killer", defaultValue: .bool(false), docker: ("--oom-kill-disable", "--oom-kill-disable"), compose: ("oom_kill_disable", "oom_kill_disable: true"), tip: "Disables OOM killer behavior."),
            disabled(.resourcesOOMScoreAdjust, .string, "OOM score adjustment", defaultValue: .string(""), docker: ("--oom-score-adj", "--oom-score-adj 500"), compose: ("oom_score_adj", "oom_score_adj: 500"), tip: "Adjusts host OOM scoring."),
            ...
            disabled(.composeLinks, .stringList, "Links", defaultValue: .stringList([]), compose: ("links", "links: [db]"), tip: "Legacy Compose links are preserved for reference."),
            disabled(.composeDependsOn, .stringList, "Dependencies", defaultValue: .stringList([]), compose: ("depends_on", "depends_on: { db: { condition: service_healthy } }"), tip: "Compose startup dependency metadata is preserved for reference."),
            disabled(.composeProvider, .string, "Provider", defaultValue: .string(""), compose: ("provider", "provider: awesomecloud"), tip: "Compose provider metadata is preserved for future runtimes."),
