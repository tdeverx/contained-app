...
struct MaterialSurface: ViewModifier {
    ...
    init(level: Level = .regular,
         cornerRadius: CGFloat = UI.Tokens.Radius.card,
         glass: Glass = .regular,
         shadow: Bool = true,
         fill: Color? = nil,
...
struct MaterialCapsuleSurface: ViewModifier {
    var level: MaterialSurface.Level
    var glass: Glass
    var shadow: Bool
    var fill: Color?
    var fillOpacity: Double
    ...
    init(level: MaterialSurface.Level = .regular,
         glass: Glass = .regular,
         shadow: Bool = true,
         fill: Color? = nil,
         fillOpacity: Double = 0.18) {
...
extension View {
    func materialSurface(_ level: MaterialSurface.Level = .regular,
                      cornerRadius: CGFloat = UI.Tokens.Radius.card,
                      glass: Glass = .regular,
                      shadow: Bool = true,
                      fill: Color? = nil,
        ...
        modifier(MaterialSurface(level: level, cornerRadius: cornerRadius, glass: glass,
                              shadow: shadow, fill: fill, fillOpacity: fillOpacity, gradient: gradient,
                              gradientAngle: gradientAngle))
    }

    func materialCapsuleSurface(_ level: MaterialSurface.Level = .regular,
                             glass: Glass = .regular,
                             shadow: Bool = true,
                             fill: Color? = nil,
                             fillOpacity: Double = 0.18) -> some View {
        modifier(MaterialCapsuleSurface(level: level,
                                     glass: glass,
                                     shadow: shadow,
                                     fill: fill,
