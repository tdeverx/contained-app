...
struct OptionTile: View {
    ...
    public var body: some View {
        Button {
            ...
            VStack(alignment: .leading, spacing: UI.Tokens.Space.xs) {
            ...
            .designOptionTileSurface(cornerRadius: UI.Tokens.Radius.card, interactive: enabled)
            .contentShape(RoundedRectangle(cornerRadius: UI.Tokens.Radius.card, style: .continuous))
