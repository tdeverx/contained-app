...
public struct MorphTarget {
    ...
    public static func anchored(size: CGSize,
                                safeArea: MorphSafeAreaPolicy = .toolbarChrome,
                                margin: CGFloat = MorphGeometry.defaultMargin) -> MorphTarget {
        MorphTarget(placement: .anchored,
                       safeArea: safeArea,
                       margin: margin,
    ...
    public static func centered(size: CGSize,
                                safeArea: MorphSafeAreaPolicy = .content,
                                margin: CGFloat = MorphGeometry.defaultMargin) -> MorphTarget {
        MorphTarget(placement: .centered,
                       safeArea: safeArea,
                       margin: margin,
                       proposedSize: { _ in size })
    }

    public static func centered(safeArea: MorphSafeAreaPolicy = .content,
                                margin: CGFloat = MorphGeometry.defaultMargin,
                                proposedSize: @escaping (CGRect) -> CGSize) -> MorphTarget {
        MorphTarget(placement: .centered,
                       safeArea: safeArea,
                       margin: margin,
    ...
    public func rect(origin: CGRect,
                     in container: CGSize,
                     safeAreas: MorphSafeAreaManager,
...
public enum MorphGeometry {
    public static let defaultMargin: CGFloat = DesignTokens.Space.l
    public static let centeredTopMargin: CGFloat = DesignTokens.Space.xxl * 2
    ...
    public static func fittedSize(_ proposed: CGSize, in bounds: CGRect,
        ...
        return CGSize(width: min(max(DesignTokens.PanelSize.minWidth, proposed.width), maxWidth),
                      height: min(max(DesignTokens.PanelSize.minHeight, proposed.height), maxHeight))
    }
...
public struct MorphingExpander<Content: View>: View {
    ...
    var sourceCornerRadius = DesignTokens.Toolbar.groupRadius
    var targetCornerRadius = DesignTokens.Radius.sheet
    ...
    public init(isPresented: Binding<Bool>,
         originFrame: CGRect,
         target: MorphTarget = .centered(size: CGSize(width: 460, height: 440)),
         backdropStyle: GlobalBackdropStyle = .dim,
         showsBackdrop: Bool = true,
         showsPanelShadow: Bool = true,
         closeRequestToken: Int = 0,
         sourceCornerRadius: CGFloat = DesignTokens.Toolbar.groupRadius,
         targetCornerRadius: CGFloat = DesignTokens.Radius.sheet,
