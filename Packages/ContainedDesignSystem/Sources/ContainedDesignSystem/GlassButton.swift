...
public struct GlassButtonInputItem<Content: View>: View {
    public var spacing = Tokens.Toolbar.searchIconGap
    @ViewBuilder var content: () -> Content

    public init(spacing: CGFloat = Tokens.Toolbar.searchIconGap,
...
public struct GlassButton<Content: View>: View {
    ...
    public var height: CGFloat = Tokens.Toolbar.buttonGroupHeight
